...
export function PlannerPlanCard({
  ...
  return (
    <Card
      key={plan.id}
      className="hover:shadow-lg transition-shadow relative group flex flex-col items-stretch h-full cursor-pointer"
      onClick={onClick}
      tabIndex={0}
      role="button"
    ...
    >
      ...
      {/* Card Content */}
      <div className="w-full flex-1 flex flex-col justify-center px-4 py-4">
        {/* Title + delete row */}
